...
class CCStartLayer : public CCLayer,
                    public cocos2d::extension::CCBSelectorResolver
{
public:
    static CCScene* scene();
    
    CCB_STATIC_NEW_AUTORELEASE_OBJECT_WITH_INIT_METHOD(CCStartLayer, create);
...
class CCStartLayerLoader : public extension::CCLayerLoader
{
public:
    CCB_STATIC_NEW_AUTORELEASE_OBJECT_METHOD(CCStartLayerLoader, loader);
    
protected:
    CCB_VIRTUAL_NEW_AUTORELEASE_CREATECCNODE_METHOD(CCStartLayer);
};
#endif
